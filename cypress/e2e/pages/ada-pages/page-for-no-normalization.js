...
class PageForNoNormalization {
  createNewStudyForNoNormalization() {
    const title = FixtureDataService.findFixtureDataByKey("U_study_5_15_title");
    const des = FixtureDataService.findFixtureDataByKey("U_study_5_15_description");
    const tag = FixtureDataService.findFixtureDataByKey("U_study_5_15_tag");
  ...
  createNewStudyForNoNormalizationAuto() {
    const title = FixtureDataService.findFixtureDataByKey("U_study2_5_15_title");
    const des = FixtureDataService.findFixtureDataByKey("U_study2_5_15_description");
    const tag = FixtureDataService.findFixtureDataByKey("U_study2_5_15_tag");
...
export default PageForNoNormalization;
